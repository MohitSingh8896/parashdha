...
public class LearnHeader implements Parcelable {
    @SerializedName("id")
    @Expose
    @Nullable
    private String id;
    ...
    public static final Creator<LearnHeader> CREATOR = new Creator<LearnHeader>() {
        @Override
        public LearnHeader createFromParcel(Parcel in) {
            return new LearnHeader(in);
        }

        @Override
        public LearnHeader[] newArray(int size) {
            return new LearnHeader[size];
        }
    };
