...
class RenderingHandler extends Handler {
    ...
    public PagePart proceed(RenderingTask renderingTask) throws PageRenderingException {
    ...
    public void calculateBounds(int width, int height, RectF pageSliceBounds) {
        renderMatrix.reset();
